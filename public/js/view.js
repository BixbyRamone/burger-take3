$(document).ready(function() {
    ...
    var toeatContainer = $(".toeat-container");
    ...
    function initializeRows() {
        ...
        for (var i = 0; i < todos.length; i++) {
            ...
            if (!todos[i].eaten) {
                ...
                rowsToEat.push(createNewRowEaten(todos[i]))
                toeatContainer.prepend(rowsToEat);
            };
    ...
    function toggleComplete() {
        var todo = $(this)
            .parent()
            .data("todo");
        console.log("inside toggleComplete", todo);
        console.log(todo.eaten);


        // todo.eaten = false;
        todo.eaten = !todo.eaten;
        updateTodo(todo);
    }
    ...
    function createNewRowEaten(todo) {
        ...
        var newCompleteBtn = $("<button>");
        newCompleteBtn.addClass("complete btn btn-default");
        newCompleteBtn.text("Make Another");
        newInputRow.append(newDeleteBtn);
        newInputRow.append(newCompleteBtn);
        newInputRow.data("todo", todo);
